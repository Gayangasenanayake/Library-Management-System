...
<head>
  ...
  <title>Staff | Extend Return Date</title>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <li class="nav-item">
                                <a href="/extend-Return" class="nav-link active">
                                <i class="far fa-circle nav-icon"></i>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @endif
                                            @if($row['status'] == 1)    
                                                <td><a href="{{route('staff.extends.books', $row->id)}}" class="btn btn-danger">Extend Return Date</a> </td>
                                            @else
