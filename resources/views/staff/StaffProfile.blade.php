                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 text-center">
                                        <br><br>
                                        <b>Name : </b><p class="font-italic"><?php echo $staff_data->First_Name." ".$staff_data->Last_Name ; ?></p>
                                        <b>Staff ID :</b><p class="font-italic">{{Auth::user()->memberid}}</p> <br> 
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <form method="post" action="/staffSaveEditedData">
                                            {{csrf_field()}}
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">First Name</label>
                                                <input type="text" class="form-control" id="exampleFName" name="s_fname" value="{{$staff_data->First_Name}}" <?php echo $dis;?>>
                                            </div>
                                           
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Registration Number</label>
                                                <input type="text" class="form-control" id="exampleRegNo" name="s_rnumber" value="{{$staff_data->staff_Id}}" disabled>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Date of Birth</label>
                                                <input type="date" class="form-control" id="exampleDOB" name="s_dob" value="{{$staff_data->DOB}}" <?php echo $dis;?>>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Telephone Number</label>
                                                <input type="number" class="form-control" id="exampleTeleNo" name="s_tel" value="{{$staff_data->TeleNum}}" <?php echo $dis;?>>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleLName" name="s_lname" value="{{$staff_data->Last_Name}}" <?php echo $dis;?>>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Gender</label>
                                                <input type="text" class="form-control" id="exampleGender" name="s_gender" value="{{$staff_data->Gender}}" <?php echo $dis;?>>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Address</label>
                                                <input type="text" class="form-control" id="exampleAdd" name="s_address" value="{{$staff_data->Address}}" <?php echo $dis;?>>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Email Address</label>
                                                <input type="email" class="form-control" id="exampleemail" name="s_email" value="{{$staff_data->Email}}" readonly>
                                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <div class="text-center">
                                    ...
                                    <div class="panel-body">
                                        <form method="post" action="/staffSavePassword">
                                            {{csrf_field()}}
                                            <div class="form-group">
